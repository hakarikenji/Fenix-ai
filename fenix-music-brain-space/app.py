# Fenix Music brain — always-on API for the free HF CPU Space.
...
#   ADAPTER_ZIP_URL=https://huggingface.co/<repo>/resolve/main/fenix-music-adapter.zip
import os
import threading
import zipfile
...
ADAPTER_ZIP_URL = os.environ.get(
    "ADAPTER_ZIP_URL",
    "https://huggingface.co/Hakari66684/fenix-music-lora/resolve/main/fenix-music-adapter.zip",
)
